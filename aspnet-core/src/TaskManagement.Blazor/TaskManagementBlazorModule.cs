...
using TaskManagement.Blazor.Client;
using Volo.Abp;
...
namespace TaskManagement.Blazor;
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        app.UseConfiguredEndpoints(builder =>
        {
            builder.MapRazorComponents<App>()
                ...
                .AddAdditionalAssemblies(WebAppAdditionalAssembliesHelper.GetAssemblies<TaskManagementBlazorClientModule>());
        });
    }
}
