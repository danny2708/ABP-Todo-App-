...
public class MongoDbTaskManagementDbSchemaMigrator : ITaskManagementDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbTaskManagementDbSchemaMigrator(IServiceProvider serviceProvider)
    {
