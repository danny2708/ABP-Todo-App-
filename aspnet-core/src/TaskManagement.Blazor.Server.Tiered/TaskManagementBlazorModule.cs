...
using TaskManagement.Blazor.Server.Tiered.Components;
using TaskManagement.Blazor.Server.Tiered.Menus;
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/TaskManagement.Blazor.Server.Tiered.styles.css", true));
                }
            );
        });
    }
