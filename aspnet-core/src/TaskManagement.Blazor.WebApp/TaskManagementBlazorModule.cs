...
using TaskManagement.Blazor.WebApp.Client;
using TaskManagement.Blazor.WebApp.Client.Menus;
using TaskManagement.Blazor.WebApp.Components;
...
public class TaskManagementBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(TaskManagementDomainModule).Assembly,
                typeof(TaskManagementDomainSharedModule).Assembly,
                typeof(TaskManagementApplicationModule).Assembly,
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "76f5ec07-b894-4300-b8d3-1a69c66ef568");
            });
        }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddMapperlyObjectMapper<TaskManagementBlazorModule>();
    }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/TaskManagement.Blazor.WebApp.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new TaskManagementMenuContributor(context.Services.GetConfiguration()));
        });
    }
